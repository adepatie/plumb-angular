  ...
  function setupPlumb() {
    ...
    w[PLUMB_CONFIG.ANGULAR].module('PlumbApp').run([
      ...
      function ($templateCache) {
        ...
        $templateCache.put('plumb-templates/menu/button-cart.html', '<md-button class="md-fab md-raised md-mini" ng-click="menuService.toggle(\'cart\')" ng-class="menuService.checkClass(\'cart\')">\n' + '  <md-tooltip md-direction="{{config.menuTooltipDirection}}">\n' + '    {{mi.name}}\n' + '  </md-tooltip>\n' + '  <span class="material-icons">shopping_cart</span>\n' + '</md-button>\n');
        $templateCache.put('plumb-templates/menu/button.html', '<md-button class="md-fab md-raised md-mini" ng-href="{{menuService.getUri(mi)}}" ng-click="mi.onClick ? mi.onClick() : menuService.toggle(mi.tag)" class="menuService.checkClass(mi.tag)">\n' + '  <md-tooltip md-direction="{{config.menuTooltipDirection}}">{{mi.name}}</md-tooltip>\n' + '  <span class="material-icons">{{mi.icon}}</span>\n' + '</md-button>\n');
      ...
      function ($rootScope, $http, plumbConfig, $q) {
        ...
        var Plumb = function (opts) {
          ...
          function purchase_order(options) {
            var $scope = new payment_method({ type: 'purchase_order' });
            $scope = w[PLUMB_CONFIG.ANGULAR].extend($scope, options);
            return $scope;
          }
      ...
      function (plumb, plumbConfig, $rootScope, $filter) {
        ...
        $scope.setMultiVariant = function (product, name, option) {
          ...
          product.variants.push({
            ...
            sku: option.sku,
            manufacturer_sku: option.manufacturer_sku
          });
          return product;
        };
